...
class SAC_Settings(PropertyGroup):
    ...
    def update_filter_type(self, context):
        ...
        filter_types.clear()
        filter_types.append(("Default", "Default"))
    ...
    def update_Colorgrade_Curves_RGB_Intensity(self, context):
        scene = bpy.context.scene
        settings = scene.sac_settings
        bpy.data.node_groups[".SAC Curves"].nodes["SAC Colorgrade_Curves_RGB"].inputs["Factor"].default_value = settings.Colorgrade_Curves_RGB_Intensity
    ...
    def update_Colorgrade_Curves_HSV_Intensity(self, context):
        scene = bpy.context.scene
        settings = scene.sac_settings
        bpy.data.node_groups[".SAC Curves"].nodes["SAC Colorgrade_Curves_HSV"].inputs["Factor"].default_value = settings.Colorgrade_Curves_HSV_Intensity
    ...
    def update_Effects_FogGlow_Threshold(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_FogGlow"].inputs["Threshold"].default_value = settings.Effects_FogGlow_Threshold
    ...
    def update_Effects_FogGlow_Size(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_FogGlow"].inputs["Size"].default_value = settings.Effects_FogGlow_Size + 5
    ...
    def update_Effects_Streaks_Threshold(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Threshold"].default_value = settings.Effects_Streaks_Threshold
    ...
    def update_Effects_Streaks_Count(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Streaks"].default_value = settings.Effects_Streaks_Count
    ...
    def update_Effects_Streaks_Angle(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Streaks Angle"].default_value = settings.Effects_Streaks_Angle
    ...
    def update_Effects_Streaks_Distortion(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Color Modulation"].default_value = settings.Effects_Streaks_Distortion
    ...
    def update_Effects_Streaks_Fade(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Fade"].default_value = settings.Effects_Streaks_Fade
    ...
    def update_Effects_Streaks_Length(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Iterations"].default_value = settings.Effects_Streaks_Length + 1
    ...
    def update_Effects_Ghosts_Threshold(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Ghosts"].inputs["Threshold"].default_value = settings.Effects_Ghosts_Threshold
    ...
    def update_Effects_Ghosts_Distortion(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Ghosts"].inputs["Color Modulation"].default_value = settings.Effects_Ghosts_Distortion
    ...
    def update_Effects_Ghosts_Count(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Ghosts"].inputs["Iterations"].default_value = settings.Effects_Ghosts_Count
    ...
    def update_Effects_Vignette_Feather(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Viginette_Directional_Blur"].inputs["Scale"].default_value = settings.Effects_Vignette_Feather
        ...
        if feather_value <= 0.05:
            node_to_update.inputs["Samples"].default_value = 4
        elif feather_value <= 0.2:
            node_to_update.inputs["Samples"].default_value = 5
        elif feather_value <= 0.4:
            node_to_update.inputs["Samples"].default_value = 6
        else:  # feather_value > 0.4
            node_to_update.inputs["Samples"].default_value = 7
    ...
    def update_Effects_Negative(self, context):
        ...
        node_name = f"{item.EffectGroup}_{item.ID}"
        node_group_name = f".{node_name}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Negative"].inputs["Factor"].default_value = settings.Effects_Negative
    ...
    def update_Effects_Warp(self, context):
        ...
        warp_node.inputs["Scale"].default_value = settings.Effects_Warp
        ...
        if warp_value <= 0.05:
            warp_node.inputs["Samples"].default_value = 4
        elif warp_value <= 0.2:
            warp_node.inputs["Samples"].default_value = 5
        elif warp_value <= 0.4:
            warp_node.inputs["Samples"].default_value = 6
        else:  # warp_value > 0.4
            warp_node.inputs["Samples"].default_value = 7
    ...
    def update_Filmgrain_dustproportion(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_FilmGrain_Blur"].inputs["Threshold"].default_value = settings.Filmgrain_dustproportion
    ...
    def update_Filmgrain_size(self, context):
        ...
        item = context.scene.sac_effect_list[index] if context.scene.sac_effect_list else None
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_FilmGrain_Blur"].inputs["Size"].default_value = settings.Filmgrain_size
    ...
    def update_Effects_Bokeh_MaxSize(self, context):
        ...
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Blur"].inputs["Size"].default_value = settings.Effects_Bokeh_MaxSize
    ...
    def update_Effects_Bokeh_Procedural_Flaps(self, context):
        ...
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Procedural"].inputs["Flaps"].default_value = settings.Effects_Bokeh_Procedural_Flaps
    ...
    def update_Effects_Bokeh_Procedural_Angle(self, context):
        ...
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Procedural"].inputs["Angle"].default_value = settings.Effects_Bokeh_Procedural_Angle
    ...
    def update_Effects_Bokeh_Procedural_Rounding(self, context):
        ...
        node_group_name = f".{item.EffectGroup}_{item.ID}"
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Procedural"].inputs["Roundness"].default_value = settings.Effects_Bokeh_Procedural_Rounding
    ...
    def update_Effects_Bokeh_Procedural_Catadioptric(self, context):
        ...
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Procedural"].inputs["Catadioptric Size"].default_value = settings.Effects_Bokeh_Procedural_Catadioptric
    ...
    def update_Effects_Bokeh_Procedural_Shift(self, context):
        ...
        bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Procedural"].inputs["Color Shift"].default_value = settings.Effects_Bokeh_Procedural_Shift
    ...
    def update_Effects_Bokeh_Type(self, context):
        ...
        if settings.Effects_Bokeh_Type == 'PROCEDURAL':
            bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Switch"].inputs["Switch"].default_value = True
        else:
            bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Switch"].inputs["Switch"].default_value = False
            if settings.Effects_Bokeh_Type == 'CUSTOM':
                bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_ImageSwitch"].inputs["Switch"].default_value = True
            else:
                bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_ImageSwitch"].inputs["Switch"].default_value = False
