...
from ...pidgeon_tool_bag.PTB_Functions import ensure_scene_compositor_tree, get_compositor_output_node
...
def connect_renderLayer_node():
    ...
    for render_layer_node in render_layer_nodes:
        ...
        if not sac_node:
            ...
            output_node = get_compositor_output_node(tree)
            tree.links.new(sac_node.outputs[0], output_node.inputs[0])
        else:
            sac_node.node_tree = create_main_group()
