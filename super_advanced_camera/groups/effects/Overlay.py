...
def create_overlay_group() -> NodeTree:
    ...
    # Create the nodes
    mix_node = sac_overlay_group.nodes.new("ShaderNodeMix")
    ...
    # Create the links
    link_nodes(sac_overlay_group, input_node, 0, mix_node, 6)
    link_nodes(sac_overlay_group, texture_node, 0, mix_node, 7)
    link_nodes(sac_overlay_group, mix_node, 2, output_node, 0)
