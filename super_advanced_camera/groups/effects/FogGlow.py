...
def create_fogglow_group() -> NodeTree:
    ...
    fogglow_node_1.inputs["Type"].default_value = "Fog Glow"
    fogglow_node_1.inputs["Quality"].default_value = "High"
    fogglow_node_1.inputs["Size"].default_value = 7

    color_mix_node_1 = sac_fogglow_group.nodes.new("ShaderNodeMix")
    ...
    link_nodes(sac_fogglow_group, input_node, 0, color_mix_node_1, 6)
    link_nodes(sac_fogglow_group, fogglow_node_1, 1, color_mix_node_1, 7)
    link_nodes(sac_fogglow_group, color_mix_node_1, 2, output_node, 0)
