...
def create_gradientmap_group() -> NodeTree:
    ...
    # Create the nodes
    gradientmap_node = sac_gradientmap_group.nodes.new("ShaderNodeValToRGB")
    gradientmap_node.name = "SAC Effects_GradientMap"

    colormix_node = sac_gradientmap_group.nodes.new("ShaderNodeMix")
    colormix_node.data_type = "RGBA"
    ...
    link_nodes(sac_gradientmap_group, gradientmap_node, 0, colormix_node, 7)
    link_nodes(sac_gradientmap_group, input_node, 0, colormix_node, 6)
    link_nodes(sac_gradientmap_group, colormix_node, 2, output_node, 0)
