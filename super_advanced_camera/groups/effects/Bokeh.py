...
def create_bokeh_group() -> NodeTree:
    ...
    link_nodes(sac_bokeh_group, image_node, 0, switch_image_node, "Off")
    link_nodes(sac_bokeh_group, custom_node, 0, switch_image_node, "On")
    link_nodes(sac_bokeh_group, switch_image_node, 0, rotate_node, 0)
    link_nodes(sac_bokeh_group, rotate_node, 0, switch_node, "Off")
    link_nodes(sac_bokeh_group, bokeh_image_node, 0, switch_node, "On")
