...
def create_ghost_group() -> NodeTree:
    ...
    ghost_node_3.inputs["Type"].default_value = "Ghosts"
    ghost_node_3.inputs["Quality"].default_value = "High"

    color_mix_node_3 = sac_ghost_group.nodes.new("ShaderNodeMix")
    ...
    link_nodes(sac_ghost_group, input_node, 0, color_mix_node_3, 6)
    link_nodes(sac_ghost_group, ghost_node_3, 1, color_mix_node_3, 7)
    link_nodes(sac_ghost_group, color_mix_node_3, 2, output_node, 0)
