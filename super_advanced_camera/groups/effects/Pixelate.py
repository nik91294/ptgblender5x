...
def create_pixelate_group() -> NodeTree:
    ...
    # Create the nodes
    math_add_node = sac_pixelate_group.nodes.new("ShaderNodeMath")
    math_add_node.operation = "ADD"
    math_add_node.name = "SAC Effects_Pixelate_Size"
    math_add_node.inputs[1].default_value = 1

    math_divide_node = sac_pixelate_group.nodes.new("ShaderNodeMath")
    ...
    scale_node_1.inputs["Type"].default_value = "Relative"
    scale_node_2 = sac_pixelate_group.nodes.new("CompositorNodeScale")
    scale_node_2.inputs["Type"].default_value = "Relative"
    ...
    link_nodes(sac_pixelate_group, math_divide_node, 0, scale_node_1, "X")
    link_nodes(sac_pixelate_group, math_divide_node, 0, scale_node_1, "Y")
    ...
    link_nodes(sac_pixelate_group, math_add_node, 0, scale_node_2, "X")
    link_nodes(sac_pixelate_group, math_add_node, 0, scale_node_2, "Y")
