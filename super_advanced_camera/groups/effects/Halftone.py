...
def create_halftone_group() -> NodeTree:
    ...
    # Create the nodes
    value_node = sac_halftone_group.nodes.new("ShaderNodeValue")
    ...
    # Blender 5.0 removed the legacy Texture-datablock-based Texture node;
    # the Magic texture pattern is rebuilt here using the real Magic Texture
    # shader node fed by per-pixel image coordinates, plus an explicit
    # threshold (the old Texture datablock did its own color-ramp
    # thresholding internally before reaching the compositor).
    coords_node = sac_halftone_group.nodes.new("CompositorNodeImageCoordinates")

    vector_scale_node = sac_halftone_group.nodes.new("ShaderNodeVectorMath")
    vector_scale_node.operation = "MULTIPLY"
    vector_scale_node.inputs[1].default_value = (96.0, 54.0, 0.0)

    texture_node = sac_halftone_group.nodes.new("ShaderNodeTexMagic")
    texture_node.turbulence_depth = 1
    texture_node.inputs["Distortion"].default_value = 6.0
    texture_node.name = "SAC Effects_Halftone_Texture"

    texture_threshold_node = sac_halftone_group.nodes.new("ShaderNodeValToRGB")
    texture_threshold_node.color_ramp.interpolation = "CONSTANT"
    texture_threshold_node.color_ramp.elements[1].position = 0.65
    texture_threshold_node.name = "SAC Effects_Halftone_Texture_Threshold"
    ...
    delta_node = sac_halftone_group.nodes.new("ShaderNodeValue")
    ...
    link_nodes(sac_halftone_group, input_node, 0, coords_node, "Image")
    link_nodes(sac_halftone_group, coords_node, "Pixel", vector_scale_node, 0)
    link_nodes(sac_halftone_group, vector_scale_node, 0, texture_node, "Vector")
    link_nodes(sac_halftone_group, texture_node, "Factor", texture_threshold_node, 0)
    ...
    link_nodes(sac_halftone_group, texture_threshold_node, 0, halftone_part_group_node_c, "Dots")
    link_nodes(sac_halftone_group, texture_threshold_node, 0, halftone_part_group_node_r, "Dots")
    link_nodes(sac_halftone_group, texture_threshold_node, 0, halftone_part_group_node_g, "Dots")
    link_nodes(sac_halftone_group, texture_threshold_node, 0, halftone_part_group_node_b, "Dots")
    ...
    link_nodes(sac_halftone_group, halftone_part_group_node_c, "Image", switch_node, "Off")
    link_nodes(sac_halftone_group, combine_rgb_node, 0, switch_node, "On")
...
def halftonepart_group() -> NodeTree:
    ...
    # Create the nodes
    color_ramp_node_1 = halftone_part_group.nodes.new("ShaderNodeValToRGB")
    color_ramp_node_1.color_ramp.elements[0].position = 0.085

    math_multiply_node = halftone_part_group.nodes.new("ShaderNodeMath")
    math_multiply_node.operation = "MULTIPLY"

    math_add_node_1 = halftone_part_group.nodes.new("ShaderNodeMath")
    math_add_node_1.operation = "ADD"

    math_add_node_2 = halftone_part_group.nodes.new("ShaderNodeMath")
    math_add_node_2.operation = "ADD"

    math_add_node_3 = halftone_part_group.nodes.new("ShaderNodeMath")
    math_add_node_3.operation = "ADD"

    math_add_node_4 = halftone_part_group.nodes.new("ShaderNodeMath")
    math_add_node_4.operation = "ADD"

    math_greater_than_node_1 = halftone_part_group.nodes.new("ShaderNodeMath")
    math_greater_than_node_1.operation = "GREATER_THAN"
    math_greater_than_node_1.inputs[1].default_value = 0

    math_greater_than_node_2 = halftone_part_group.nodes.new("ShaderNodeMath")
    math_greater_than_node_2.operation = "GREATER_THAN"

    math_greater_than_node_3 = halftone_part_group.nodes.new("ShaderNodeMath")
    math_greater_than_node_3.operation = "GREATER_THAN"

    math_greater_than_node_4 = halftone_part_group.nodes.new("ShaderNodeMath")
    math_greater_than_node_4.operation = "GREATER_THAN"

    math_greater_than_node_5 = halftone_part_group.nodes.new("ShaderNodeMath")
    math_greater_than_node_5.operation = "GREATER_THAN"

    color_mix_node_1 = halftone_part_group.nodes.new("ShaderNodeMix")
    color_mix_node_1.data_type = "RGBA"
    color_mix_node_1.blend_type = "MIX"
    color_mix_node_1.inputs[6].default_value = (0, 0, 0, 1)

    color_mix_node_2 = halftone_part_group.nodes.new("ShaderNodeMix")
    color_mix_node_2.data_type = "RGBA"
    color_mix_node_2.blend_type = "MIX"

    color_mix_node_3 = halftone_part_group.nodes.new("ShaderNodeMix")
    color_mix_node_3.data_type = "RGBA"
    color_mix_node_3.blend_type = "MIX"

    color_mix_node_4 = halftone_part_group.nodes.new("ShaderNodeMix")
    color_mix_node_4.data_type = "RGBA"
    color_mix_node_4.blend_type = "MIX"

    color_mix_node_5 = halftone_part_group.nodes.new("ShaderNodeMix")
    color_mix_node_5.data_type = "RGBA"
    color_mix_node_5.blend_type = "MIX"
    color_mix_node_5.inputs[7].default_value = (1, 1, 1, 1)

    dialate_erode_node_1 = halftone_part_group.nodes.new("CompositorNodeDilateErode")
    dialate_erode_node_1.inputs["Type"].default_value = "Distance"
    dialate_erode_node_1.inputs["Size"].default_value = -2

    dialate_erode_node_2 = halftone_part_group.nodes.new("CompositorNodeDilateErode")
    dialate_erode_node_2.inputs["Type"].default_value = "Distance"
    dialate_erode_node_2.inputs["Size"].default_value = -1

    dialate_erode_node_4 = halftone_part_group.nodes.new("CompositorNodeDilateErode")
    dialate_erode_node_4.inputs["Type"].default_value = "Distance"
    dialate_erode_node_4.inputs["Size"].default_value = 1

    filter_soften_node = halftone_part_group.nodes.new("CompositorNodeFilter")
    filter_soften_node.inputs["Type"].default_value = "Soften"

    greater_than_node = halftone_part_group.nodes.new("ShaderNodeMath")
    ...
    link_nodes(halftone_part_group, dialate_erode_node_1, 0, color_mix_node_1, 7)
    link_nodes(halftone_part_group, dialate_erode_node_2, 0, color_mix_node_2, 7)
    link_nodes(halftone_part_group, math_multiply_node, 0, color_mix_node_3, 7)
    link_nodes(halftone_part_group, dialate_erode_node_4, 0, color_mix_node_4, 7)
    link_nodes(halftone_part_group, color_mix_node_1, 2, color_mix_node_2, 6)
    link_nodes(halftone_part_group, color_mix_node_2, 2, color_mix_node_3, 6)
    link_nodes(halftone_part_group, color_mix_node_3, 2, color_mix_node_4, 6)
    link_nodes(halftone_part_group, color_mix_node_4, 2, color_mix_node_5, 6)
    link_nodes(halftone_part_group, color_mix_node_5, 2, filter_soften_node, "Image")
