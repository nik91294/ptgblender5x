...
def create_colorwheel_group() -> NodeTree:
    ...
    color_balance_node_1.inputs["Factor"].default_value = 0

    gamma_node_1 = sac_colorwheel_group.nodes.new("ShaderNodeGamma")

    map_range_node_1 = sac_colorwheel_group.nodes.new("ShaderNodeMapRange")
    ...
    color_balance_node_2.inputs["Factor"].default_value = 0

    gamma_node_2 = sac_colorwheel_group.nodes.new("ShaderNodeGamma")

    map_range_node_2 = sac_colorwheel_group.nodes.new("ShaderNodeMapRange")
    ...
    color_balance_node_3.inputs["Factor"].default_value = 0

    exposure_node = sac_colorwheel_group.nodes.new("CompositorNodeExposure")

    map_range_node_3 = sac_colorwheel_group.nodes.new("ShaderNodeMapRange")
    ...
    # Create the links
    link_nodes(sac_colorwheel_group, input_node, 0, color_balance_node_1, "Image")
    ...
    link_nodes(sac_colorwheel_group, gamma_node_1, 0, color_balance_node_2, "Image")
    ...
    link_nodes(sac_colorwheel_group, gamma_node_2, 0, color_balance_node_3, "Image")
