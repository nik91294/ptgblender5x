...
def create_vibrance_group() -> NodeTree:
    ...
    maximum_node_1 = sac_vibrance_group.nodes.new("ShaderNodeMath")
    maximum_node_1.operation = "MAXIMUM"
    maximum_node_2 = sac_vibrance_group.nodes.new("ShaderNodeMath")
    maximum_node_2.operation = "MAXIMUM"

    minimum_node_1 = sac_vibrance_group.nodes.new("ShaderNodeMath")
    minimum_node_1.operation = "MINIMUM"
    minimum_node_2 = sac_vibrance_group.nodes.new("ShaderNodeMath")
    minimum_node_2.operation = "MINIMUM"

    subtract_node_1 = sac_vibrance_group.nodes.new("ShaderNodeMath")
    subtract_node_1.operation = "SUBTRACT"
    subtract_node_2 = sac_vibrance_group.nodes.new("ShaderNodeMath")
    subtract_node_2.operation = "SUBTRACT"
    subtract_node_2.inputs[0].default_value = 1
    subtract_node_2.use_clamp = True

    divide_node = sac_vibrance_group.nodes.new("ShaderNodeMath")
