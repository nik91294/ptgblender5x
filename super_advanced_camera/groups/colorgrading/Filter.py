...
def create_max_group() -> NodeTree:
    ...
    # Create the nodes
    math_max_1 = sac_max_group.nodes.new("ShaderNodeMath")
    math_max_1.operation = "MAXIMUM"

    math_max_2 = sac_max_group.nodes.new("ShaderNodeMath")
...
def create_filter_group() -> NodeTree:
    ...
    mix_node = sac_filter_group.nodes.new("ShaderNodeMix")
    ...
    link_nodes(sac_filter_group, separate_rgb, 0, red_channel, "Image")
    link_nodes(sac_filter_group, separate_rgb, 1, green_channel, "Image")
    link_nodes(sac_filter_group, separate_rgb, 2, blue_channel, "Image")
    ...
    link_nodes(sac_filter_group, combine_group, 0, mix_node, 7)
    link_nodes(sac_filter_group, input_node, 0, mix_node, 6)
    link_nodes(sac_filter_group, mix_node, 2, output_node, 0)
