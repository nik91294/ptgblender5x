...
def create_whites_group() -> NodeTree:
    ...
    # Create the nodes
    map_range_node = sac_whites_group.nodes.new("ShaderNodeMapRange")
    ...
    link_nodes(sac_whites_group, input_node, 0, rgb_curves_node_1, "Image")
    link_nodes(sac_whites_group, rgb_curves_node_1, 0, rgb_curves_node_2, "Image")
