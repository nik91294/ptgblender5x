        ...
        if settings.show_colorgrading:
            ...
            if not found:
                ...
                if settings.show_colorwheels:
                    ...
                    col_1.template_color_picker(color_wheel_node_lift.inputs[4], "default_value")
                    ...
                    col_2.template_color_picker(color_wheel_node_gamma.inputs[6], "default_value")
                    ...
                    col_3.template_color_picker(color_wheel_node_gain.inputs[8], "default_value")
