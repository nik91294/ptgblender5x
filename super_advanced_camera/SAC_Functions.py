...
def active_effect_update(self, context):
    ...
    if item.EffectGroup == "SAC_BOKEH":
        settings.Effects_Bokeh_MaxSize = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Blur"].inputs["Size"].default_value
        ...
        settings.Effects_Bokeh_Procedural_Flaps = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Procedural"].inputs["Flaps"].default_value
        settings.Effects_Bokeh_Procedural_Angle = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Procedural"].inputs["Angle"].default_value
        settings.Effects_Bokeh_Procedural_Rounding = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Procedural"].inputs["Roundness"].default_value
        settings.Effects_Bokeh_Procedural_Catadioptric = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Procedural"].inputs["Catadioptric Size"].default_value
        settings.Effects_Bokeh_Procedural_Shift = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Procedural"].inputs["Color Shift"].default_value

        if bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_Switch"].inputs["Switch"].default_value == True:
            settings.Effects_Bokeh_Type = "PROCEDURAL"
        else:
            if bpy.data.node_groups[node_group_name].nodes["SAC Effects_Bokeh_ImageSwitch"].inputs["Switch"].default_value == True:
    ...
    # Film Grain
        ...
        settings.Filmgrain_dustproportion = bpy.data.node_groups[node_group_name].nodes["SAC Effects_FilmGrain_Blur"].inputs["Threshold"].default_value
        settings.Filmgrain_size = bpy.data.node_groups[node_group_name].nodes["SAC Effects_FilmGrain_Blur"].inputs["Size"].default_value
    # Fish Eye
    ...
    # Fog Glow
        ...
        settings.Effects_FogGlow_Threshold = bpy.data.node_groups[node_group_name].nodes["SAC Effects_FogGlow"].inputs["Threshold"].default_value
        settings.Effects_FogGlow_Size = bpy.data.node_groups[node_group_name].nodes["SAC Effects_FogGlow"].inputs["Size"].default_value
    # Ghost
        ...
        settings.Effects_Ghosts_Threshold = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Ghosts"].inputs["Threshold"].default_value
        settings.Effects_Ghosts_Count = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Ghosts"].inputs["Iterations"].default_value
        settings.Effects_Ghosts_Distortion = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Ghosts"].inputs["Color Modulation"].default_value
    # Gradient Map
    ...
    # Negative
        ...
        settings.Effects_Negative = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Negative"].inputs["Factor"].default_value
    # Overlay
    ...
    # Streaks
        ...
        settings.Effects_Streaks_Threshold = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Threshold"].default_value
        settings.Effects_Streaks_Count = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Streaks"].default_value
        settings.Effects_Streaks_Length = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Iterations"].default_value
        settings.Effects_Streaks_Fade = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Fade"].default_value
        settings.Effects_Streaks_Angle = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Streaks Angle"].default_value
        settings.Effects_Streaks_Distortion = bpy.data.node_groups[node_group_name].nodes["SAC Effects_Streaks"].inputs["Color Modulation"].default_value
    # Vignette
